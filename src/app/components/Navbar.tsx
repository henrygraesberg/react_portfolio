...
const Navbar: FC<NavbarProps> = ({ darkMode, setDarkMode }) => {
    ...
    return (
        <nav className={`flex justify-between text-2xl w-[100vw] px-[5vw] py-[1%] bg-navbar dark:bg-navbar_dark bg-opacity-50 dark:text-text_secondary fixed z-50 ${darkMode && "dark"} transition-colors hover:duration-300`}>
